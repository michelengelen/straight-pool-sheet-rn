...
export default class AwesomeSlider extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const { value, containerSize, allMeasured } = this.state;
  ...
  renderThumb = () => {
    ...
    if (thumbComponent) return thumbComponent;
...
AwesomeSlider.propTypes = {
   ...
   */
  minimumValue: PropType.number,

  /**
   * Initial maximum value of the slider. Default value is 1.
   */
  maximumValue: PropType.number,
   ...
   */
  minimumTrackTintColor: PropType.string,

  /**
   * The color used for the track to the right of the button. Overrides the
   * default blue gradient image.
   */
  maximumTrackTintColor: PropType.string,

  /**
   * The color used for the thumb.
   */
  thumbTintColor: PropType.string,
   ...
   */
  onValueChange: PropType.func,

  /**
   * Callback called when the user starts changing the value (e.g. when
   * the slider is pressed).
   */
  onSlidingStart: PropType.func,

  /**
   * Callback called when the user finishes changing the value (e.g. when
   * the slider is released).
   */
  onSlidingComplete: PropType.func,
   ...
   */
  debugTouchArea: PropType.bool,

  /**
   * Set to true to animate values with default 'timing' animation type
   */
  animateTransitions: PropType.bool,

  /**
   * Custom Animation type. 'spring' or 'timing'.
   */
  animationType: PropType.oneOf(["spring", "timing"]),

  /**
   * Used to configure the animation parameters.  These are the same parameters in the Animated library.
   */
  animationConfig: PropType.object
};
